...
Coordenador do Curso [Adriano Barreto](https://br.linkedin.com/in/adriano-barreto-5707664a)

Um projeto coordenado pelo professor [Rodrigo J. Paiva](https://www.linkedin.com/in/rodrigojpaiva)
...
O código dessa aplicação é open-source e está disponível gratuitamente no [github](https://github.com/koka0012/APP-Corn-Party).
`;
